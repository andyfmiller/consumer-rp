        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendNames = table.Column<bool>(nullable: false),
                    SourcedId = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumerKey = table.Column<string>(maxLength: 50, nullable: true),
                    ConsumerSecret = table.Column<string>(maxLength: 50, nullable: true),
                    CreatorId = table.Column<string>(nullable: true),
                    CustomParameters = table.Column<string>(maxLength: 1024, nullable: true),
